...
def run_sft(
    ...
    *,
    ...
    # Build SFT texts (AFTER tokenizer load, to use apply_chat_template).
    # IMPORTANT:
    # - build_prompt(..., use_chat_template=true) ends with an *open* assistant turn.
    # - For SFT we MUST append an EOS token so the model learns a reliable
